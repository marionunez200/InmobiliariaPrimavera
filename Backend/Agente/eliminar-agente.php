...
try {
    ...
    // ===================================
    // SI TIENE PROPIEDADES -> SOLO DESACTIVAR
    // ===================================
    if ($totalPropiedades > 0) {
        ...
        // Desactivar también el acceso de usuario
        $stmt = $pdo->prepare("
        ...
        $_SESSION['modal_exito'] = [
            ...
            'mensaje' => 'El agente, usuario y fotografía fueron eliminados correctamente.'
        ];
    }
    ...
    error_log("Error eliminar agente: " . $e->getMessage());

    die('Ocurrió un error al eliminar el agente.');
}