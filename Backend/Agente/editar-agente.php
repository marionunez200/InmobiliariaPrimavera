...
// NUEVO: Capturar si se envió la indicación de desactivar 2FA
$desactivar2FA = isset($_POST['desactivar_2fa']) && $_POST['desactivar_2fa'] === '1';
...
try {
    ...
    */
    ...
    /*
        NUEVO: Desactivar 2FA si fue seleccionado en el modal
    */
    if ($desactivar2FA) {
        $stmt2FA = $pdo->prepare("
            UPDATE usuarios_admin SET
