...
CREATE TABLE `operaciones_realizadas` (
  ...
  `forma_pago` enum('contado','credito','financiamiento') COLLATE utf8mb4_unicode_ci DEFAULT 'contado',
  `numero_contrato` varchar(50) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `estado` enum('vigente','cancelada') COLLATE utf8mb4_unicode_ci DEFAULT 'vigente',
...
-- Dump completed on 2026-07-26 23:53:16
