...
CREATE TABLE `agentes` (
  ...
  PRIMARY KEY (`id`),
  KEY `idx_agentes_usuario` (`usuario_id`),
  CONSTRAINT `fk_agente_usuario` FOREIGN KEY (`usuario_id`) REFERENCES `usuarios_admin` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `fk_agentes_usuario` FOREIGN KEY (`usuario_id`) REFERENCES `usuarios_admin` (`id`) ON DELETE SET NULL ON UPDATE CASCADE
...
--
-- Table structure for table `operaciones_realizadas`
--

DROP TABLE IF EXISTS `operaciones_realizadas`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `operaciones_realizadas` (
  ...
  `creado_en` timestamp NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`),
  KEY `fk_operacion_agente` (`agente_id`),
  KEY `fk_operacion_propiedad` (`propiedad_id`),
  CONSTRAINT `fk_operacion_agente` FOREIGN KEY (`agente_id`) REFERENCES `agentes` (`id`) ON DELETE RESTRICT,
  CONSTRAINT `fk_operacion_propiedad` FOREIGN KEY (`propiedad_id`) REFERENCES `propiedades` (`id`) ON DELETE RESTRICT ON UPDATE CASCADE
...
-- Dump completed on 2026-07-28 15:13:49
